...
#
echo "下载openclash"
wget https://ghproxy.net/https://github.com/vernesong/OpenClash/releases/download/v0.46.014-beta/luci-app-openclash_0.46.014-beta_all.ipk -O luci-app-openclash_0.46.014-beta_all.ipk
